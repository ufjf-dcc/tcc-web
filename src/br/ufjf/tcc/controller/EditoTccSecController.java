...
public class EditoTccSecController extends CommonsController {
	...
	public void saveExtraFile() {
		String newFileName = FileManager.saveFileInputSream(extraFile, "pdf");//arrumar extensão
		if (newFileName != null) {
